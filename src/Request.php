...
class Request
{
    ...
    /**
     * @var \mphp\lib\Collection Query string parameters
     */
    public $query;

    /**
     * @var \mphp\lib\Collection Post parameters
     */
    public $data;

    /**
     * @var \mphp\lib\Collection Cookie parameters
     */
    public $cookies;

    /**
     * @var \mphp\lib\Collection Uploaded files
     */
    public $files;
    ...
    public function __construct($config = [])
    {
        ...
        if (empty($config)) {
            ...
            $config = [
                ...
                'query' => $collection->setData($_GET),
                'data' => $collection->setData($_POST),
                'cookies' => $collection->setData($_COOKIE),
                'files' => $collection->setData($_FILES),
